<x-admin-layout title="Settings CMS">
    <div class="py-12" x-data="{ tab: localStorage.getItem('active_cms_tab') || 'general' }" x-init="$watch('tab', val => localStorage.setItem('active_cms_tab', val))">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col xl:flex-row xl:items-center justify-between gap-8 mb-16" x-data="{ 
                ...
                <div class="flex items-center gap-2 p-2 bg-white/60 backdrop-blur-md rounded-[2.5rem] border border-slate-200/60 shadow-sm overflow-x-auto no-scrollbar max-w-full">
                    <button @click="tab = 'general'" 
                        :class="tab === 'general' ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-100 scale-[1.02]' : 'bg-transparent text-slate-500 hover:bg-slate-50 hover:text-slate-900'" 
                        class="px-6 py-4 rounded-[2rem] font-black uppercase text-[10px] tracking-[0.1em] transition-all duration-300 flex items-center gap-3 shrink-0">
                        <i class="fa-solid fa-gear"></i>
                        <span>Umum</span>
                    </button>

                    <button @click="tab = 'home'" 
                        :class="tab === 'home' ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-100 scale-[1.02]' : 'bg-transparent text-slate-500 hover:bg-slate-50 hover:text-slate-900'" 
                        class="px-6 py-4 rounded-[2rem] font-black uppercase text-[10px] tracking-[0.1em] transition-all duration-300 flex items-center gap-3 shrink-0">
                    ...
                    <button @click="tab = 'logistics'" 
                        :class="tab === 'logistics' ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-100 scale-[1.02]' : 'bg-transparent text-slate-500 hover:bg-slate-50 hover:text-slate-900'" 
                        class="px-6 py-4 rounded-[2rem] font-black uppercase text-[10px] tracking-[0.1em] transition-all duration-300 flex items-center gap-3 shrink-0">
                    ...
                    <button @click="tab = 'about'" 
                        :class="tab === 'about' ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-100 scale-[1.02]' : 'bg-transparent text-slate-500 hover:bg-slate-50 hover:text-slate-900'" 
                        class="px-6 py-4 rounded-[2rem] font-black uppercase text-[10px] tracking-[0.1em] transition-all duration-300 flex items-center gap-3 shrink-0">
                    ...
                    <button @click="tab = 'revenue'" 
                        :class="tab === 'revenue' ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-100 scale-[1.02]' : 'bg-transparent text-slate-500 hover:bg-slate-50 hover:text-slate-900'" 
                        class="px-6 py-4 rounded-[2rem] font-black uppercase text-[10px] tracking-[0.1em] transition-all duration-300 flex items-center gap-3 shrink-0">
                    ...
                    <button @click="tab = 'footer'" 
                        :class="tab === 'footer' ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-100 scale-[1.02]' : 'bg-transparent text-slate-500 hover:bg-slate-50 hover:text-slate-900'" 
                        class="px-6 py-4 rounded-[2rem] font-black uppercase text-[10px] tracking-[0.1em] transition-all duration-300 flex items-center gap-3 shrink-0">
                ...
                <div class="flex-shrink-0">
                    <button @click="submitActive(tab)"
                        class="w-full xl:w-auto px-12 py-5 bg-[#0F172A] text-white rounded-[2rem] font-black uppercase text-[11px] tracking-[0.2em] hover:bg-black transition-all shadow-2xl shadow-indigo-100 active:scale-95 border-b-4 border-black/20">
            ...
            <div class="w-full">
                ...
                <div class="space-y-12">
                    ...
                    <div x-show="tab === 'general'" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-12 panel-general">
                        <div class="bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 overflow-hidden border border-slate-100">
                            <div class="p-10 border-b border-slate-50 bg-slate-50/30 flex justify-between items-center">
                                <div>
                                    <h3 class="text-2xl font-black text-slate-900 tracking-tight uppercase">Identitas & Branding</h3>
                                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Kelola logo dan nama situs utama</p>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                                    ...
                                    <div class="lg:col-span-4 flex flex-col items-center">
                                        <div class="relative group/logo w-64 h-64">
                                            <div class="w-full h-full bg-slate-50 rounded-[3rem] border-8 border-white shadow-2xl shadow-slate-100 flex items-center justify-center overflow-hidden relative transition-transform duration-500 group-hover/logo:scale-[1.03] ring-1 ring-slate-100">
                                                ...
                                                @endif
                                                <div class="absolute inset-0 bg-indigo-600/5 opacity-0 group-hover/logo:opacity-100 transition-opacity duration-300"></div>
                                            </div>
                                            ...
                                            <form action="{{ route('admin.cms.update-logo') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <label for="site_logo_input" class="absolute -bottom-4 -right-4 w-16 h-16 bg-indigo-600 rounded-[1.5rem] flex items-center justify-center text-white shadow-2xl shadow-indigo-200 cursor-pointer hover:bg-black hover:rotate-12 transition-all duration-300 border-4 border-white">
                                        ...
                                        <p class="mt-8 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] italic text-center leading-relaxed">Rasio 1:1 disarankan<br>Klik ikon kamera ganti logo</p>
                                    </div>
                                        ...
                                        <form action="{{ route('admin.cms.update-text') }}" method="POST" class="space-y-12 cms-form primary-form">
                                            ...
                                            <div class="grid grid-cols-1 gap-12">
                                                <div class="relative group">
                                                    <label class="block text-[11px] font-black uppercase tracking-[0.4em] text-slate-400 mb-5 px-2 group-focus-within:text-indigo-600 transition-colors">NAMA SITUS</label>
                                                    <div class="relative">
                                                ...
                                                <div class="relative group">
                                                    <label class="block text-[11px] font-black uppercase tracking-[0.4em] text-slate-400 mb-5 px-2 group-focus-within:text-indigo-600 transition-colors">SLOGAN / TAGLINE</label>
                                                    <div class="relative">
                                                        <div class="absolute inset-y-0 left-0 pl-10 flex items-center pointer-events-none text-slate-300 group-focus-within:text-indigo-600 transition-colors">
                    ...
                    <div x-show="tab === 'home'" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-8 panel-home">
                        ...
                        <div class="bg-white rounded-[2rem] shadow-xl shadow-gray-100 overflow-hidden border border-gray-100">
                            <div class="p-8 border-b border-gray-50 bg-gray-50/50 flex justify-between items-center">
                                <div>
                                    <h3 class="text-xl font-black text-gray-900 tracking-tight">Home Banner Sliders</h3>
                                    <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Banner bergerak di halaman utama (Rasio 21:9)</p>
                                </div>
                                <button onclick="document.getElementById('home_sliders_input').click()" class="px-5 py-2.5 bg-indigo-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-indigo-100 hover:scale-[1.05] transition-all">TAMBAH SLIDER BOLO</button>
                            </div>
                            <div class="p-8">
                        ...
                        <div class="bg-white rounded-[2rem] shadow-xl shadow-slate-100/50 overflow-hidden border border-slate-100/50 mt-8">
                            <div class="p-8 border-b border-slate-50 bg-slate-50/30">
                                <h3 class="text-xl font-black text-slate-900 tracking-tight">Home Secondary Banner</h3>
                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Banner statis tambahan di bawah slider</p>
                            </div>
                            <div class="p-8 space-y-8">
                                <div class="w-full h-56 bg-slate-100 rounded-[2rem] overflow-hidden relative group border-4 border-white shadow-inner">
                                ...
                                <form action="{{ route('admin.cms.update-images') }}" method="POST" enctype="multipart/form-data" class="flex flex-col lg:flex-row gap-6">
                                    @csrf
                                    <div class="flex-1">
                                        <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-4 italic">UPLOAD BANNER (.JPG, .PNG)</label>
                                        <div class="relative group/file">
                                            <input type="file" name="hero_banner" id="hero_banner_input" class="hidden" onchange="initCropper(this, 21/9, 'hero_banner')">
                                            <label for="hero_banner_input" class="flex items-center justify-center gap-4 w-full py-5 bg-slate-50 border-2 border-dashed border-slate-200 rounded-[2rem] text-[10px] font-black uppercase tracking-[0.15em] text-slate-400 cursor-pointer hover:border-indigo-600 hover:text-indigo-600 hover:bg-indigo-50/30 transition-all duration-300">
                                ...
                                <form action="{{ route('admin.cms.update-text') }}" method="POST" class="space-y-10 cms-form primary-form pt-10 border-t border-slate-50">
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-4 items-center gap-6 group">
                                        ...
                                        <div class="lg:col-span-3">
                                            <input type="text" name="home_title" value="{{ $settings['home_title'] ?? 'Belanja Keren di Mojokerto' }}" class="w-full px-10 py-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all duration-300">
                                        </div>
                                    </div>
                                    
                                    <div class="pt-4 space-y-10">
                                        <div class="grid grid-cols-1 lg:grid-cols-4 items-center gap-6 group">
                                            <label class="lg:col-span-1 text-[11px] font-black uppercase tracking-[0.25em] text-slate-400 group-focus-within:text-indigo-600 transition-colors">JUDUL SECTION TOKO</label>
                                            <div class="lg:col-span-3">
                                                <input type="text" name="trusted_sellers_title" value="{{ $settings['trusted_sellers_title'] ?? 'Toko Pilihan Bolo' }}" class="w-full px-10 py-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all duration-300">
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-1 lg:grid-cols-4 items-center gap-6 group">
                                            <label class="lg:col-span-1 text-[11px] font-black uppercase tracking-[0.25em] text-slate-400 group-focus-within:text-indigo-600 transition-colors">SUB-JUDUL TOKO</label>
                                            <div class="lg:col-span-3">
                                                <input type="text" name="trusted_sellers_subtitle" value="{{ $settings['trusted_sellers_subtitle'] ?? 'Belanja aman dari seller terpercaya' }}" class="w-full px-10 py-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all duration-300">
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <div class="flex justify-end pt-4">
                                        <button class="px-12 py-6 bg-slate-900 text-white rounded-[2.5rem] font-black uppercase text-[11px] tracking-[0.3em] hover:bg-black hover:scale-[1.02] active:scale-95 transition-all duration-300 shadow-2xl shadow-slate-200">SIMPAN TEKS BANNER BOLO</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 overflow-hidden border border-slate-100 ring-1 ring-slate-100">
                            <div class="p-10 border-b border-slate-50 bg-slate-50/10">
                                <div class="flex items-center gap-6">
                                    ...
                                    <div>
                                        <h3 class="text-2xl font-black text-slate-900 tracking-tight uppercase">Perhitungan Tarif & Ongkir</h3>
                                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Konfigurasi tarif dasar yang akan dikalikan dengan multiplier kurir</p>
                                    </div>
                                </div>
                            </div>
                            <div class="p-10 sm:p-16">
                                <form action="{{ route('admin.cms.update-text') }}" method="POST" class="grid grid-cols-1 gap-y-12 cms-form primary-form">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                        <div class="space-y-4 group">
                                            <label class="block text-[11px] font-black uppercase tracking-[0.2em] text-slate-400 px-2 group-focus-within:text-indigo-600">ONGKIR MINIMAL</label>
                                        ...
                                        <div class="space-y-4 group">
                                            <label class="block text-[11px] font-black uppercase tracking-[0.2em] text-slate-400 px-2 group-focus-within:text-indigo-600">BIAYA PER KM</label>
                                            <input type="number" name="shipping_per_km" value="{{ $settings['shipping_per_km'] ?? '2000' }}" 
                                                class="w-full px-8 py-6 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                                        </div>

                                        <div class="space-y-4 group">
                                            <label class="block text-[11px] font-black uppercase tracking-[0.2em] text-slate-400 px-2 group-focus-within:text-indigo-600">BIAYA PER KG</label>
                                    ...
                                    <div class="bg-indigo-50/50 p-10 rounded-[2.5rem] border border-indigo-100/50 flex flex-col md:flex-row gap-8 items-center mt-4">
                                        <div class="w-16 h-16 bg-white rounded-[1.5rem] text-indigo-600 flex items-center justify-center shrink-0 shadow-sm border border-indigo-50">
                        ...
                        <div class="bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 overflow-hidden border border-slate-100 ring-1 ring-slate-100">
                            <div class="p-10 border-b border-slate-50 bg-slate-50/30 flex justify-between items-center flex-wrap gap-4">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-2xl font-black text-slate-900 tracking-tight uppercase">Daftar Layanan Kurir</h3>
                                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Kelola aturan multiplier ditiap jenis layanan</p>
                                    </div>
                                </div>
                                <button onclick="openModal('addCourierModal')" class="px-8 py-5 bg-indigo-600 text-white rounded-[2rem] font-black uppercase text-[10px] tracking-widest shadow-xl shadow-indigo-100 hover:bg-indigo-700 hover:scale-[1.05] transition-all flex items-center gap-3">
                            ...
                            <div class="p-4 sm:p-10">
                                <div class="overflow-x-auto custom-scrollbar">
                                    <table class="w-full text-left min-w-[900px]">
                                        <thead>
                                            <tr>
                                                <th class="pb-8 px-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Layanan</th>
                                                <th class="pb-8 px-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Parameter Biaya</th>
                                                <th class="pb-8 px-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Limitansi</th>
                                                <th class="pb-8 px-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Status</th>
                                                <th class="pb-8 px-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 text-right">Aksi</th>
                                            </tr>
                                        </thead>
                                        <tbody class="divide-y divide-slate-100">
                                            ...
                                            <tr class="group hover:bg-slate-50 transition-all duration-300">
                                                <td class="py-8 px-6">
                                                    <div class="flex items-center gap-4">
                                                        <div class="w-12 h-12 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-center text-slate-400 group-hover:bg-indigo-600 group-hover:text-white transition-all shadow-sm">
                                                            <i class="fa-solid fa-truck-pickup text-sm"></i>
                                                        </div>
                                                        <div>
                                                            <p class="font-black text-sm text-slate-900 uppercase group-hover:text-indigo-600 transition-colors">{{ $courier->name }}</p>
                                                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1 italic">{{ $courier->service_name }} • {{ $courier->estimated_time }}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="py-8 px-6">
                                                    <div class="flex flex-col gap-2">
                                                        <span class="inline-flex px-3 py-1 bg-indigo-50 text-indigo-700 rounded-lg font-black text-[9px] tracking-widest uppercase border border-indigo-100 w-fit">Multiplier: x{{ $courier->multiplier }}</span>
                                                        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wide">Extra Fee: Rp{{ number_format($courier->base_extra_cost ?? 0, 0, ',', '.') }}</span>
                                                    </div>
                                                </td>
                                                <td class="py-8 px-6">
                                                    <div class="flex flex-col gap-2">
                                                        <span class="text-[10px] font-black text-slate-700 uppercase tracking-wide">Jarak Max: {{ $courier->max_distance ?? '∞' }} KM</span>
                                                        <span class="text-[10px] font-black text-indigo-400 uppercase tracking-wide">Beban Max: {{ $courier->max_weight ?? '∞' }} KG</span>
                                                    </div>
                                                </td>
                                                <td class="py-8 px-6">
                                                    <span class="inline-flex px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-[0.1em] {{ $courier->is_active ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' : 'bg-rose-50 text-rose-600 border border-rose-100' }}">
                                                ...
                                                <td class="py-8 px-6 text-right">
                                                    <div class="flex items-center justify-end gap-3">
                                                        ...
                                                        <button onclick="toggleCourier({{ $courier->id }})" class="w-10 h-10 bg-white border border-slate-100 rounded-xl flex items-center justify-center text-slate-400 hover:bg-indigo-600 hover:text-white transition-all shadow-sm">
                    ...
                    <div x-show="tab === 'about'" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-8 panel-about">
                        <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-100/50 overflow-hidden border border-slate-100/50">
                            ...
                            <form action="{{ route('admin.cms.update-text') }}" method="POST" class="p-10 space-y-12 cms-form primary-form">
                                ...
                                <div class="grid grid-cols-1 gap-10">
                                    <div class="grid grid-cols-1 lg:grid-cols-4 items-center gap-6 group">
                                        <label class="lg:col-span-1 text-[11px] font-black uppercase tracking-[0.25em] text-slate-400 group-focus-within:text-indigo-600 transition-colors">JUDUL HERO</label>
                                        <div class="lg:col-span-3">
                                            <input type="text" name="about_hero_title" value="{{ $settings['about_hero_title'] ?? 'Jembatan Keren Pelaku UMKM Mojokerto.' }}" class="w-full px-10 py-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all duration-300">
                                        </div>
                                    </div>

                                    <div class="grid grid-cols-1 lg:grid-cols-4 items-start gap-6 group">
                                        <label class="lg:col-span-1 text-[11px] font-black uppercase tracking-[0.25em] text-slate-400 group-focus-within:text-indigo-600 transition-colors pt-6">DESKRIPSI ABOUT</label>
                                        <div class="lg:col-span-3">
                                            <textarea name="about_hero_desc" rows="5" class="w-full px-10 py-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all duration-300 resize-none">{{ $settings['about_hero_desc'] ?? '' }}</textarea>
                                        </div>
                                    </div>

                                    <div class="grid lg:grid-cols-2 gap-10">
                                        <div class="grid grid-cols-1 lg:grid-cols-4 items-center gap-6 group">
                                            <label class="lg:col-span-1 text-[11px] font-black uppercase tracking-[0.1em] text-slate-400 group-focus-within:text-indigo-600 transition-colors">MISI 1</label>
                                            <div class="lg:col-span-3">
                                                <input type="text" name="about_mission_1" value="{{ $settings['about_mission_1'] ?? '' }}" class="w-full px-10 py-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all duration-300">
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-1 lg:grid-cols-4 items-center gap-6 group">
                                            <label class="lg:col-span-1 text-[11px] font-black uppercase tracking-[0.1em] text-slate-400 group-focus-within:text-indigo-600 transition-colors">MISI 2</label>
                                            <div class="lg:col-span-3">
                                                <input type="text" name="about_mission_2" value="{{ $settings['about_mission_2'] ?? '' }}" class="w-full px-10 py-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all duration-300">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="p-10 border-t border-slate-50 bg-slate-50/10">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-6 italic">FOTO SECTION ABOUT (16:9)</label>
                                <div class="flex flex-col lg:flex-row gap-10 items-start">
                                    <div class="w-full lg:w-72 h-44 bg-slate-100 rounded-[2rem] overflow-hidden shadow-inner flex-shrink-0 border-4 border-white">
                                        ...
                                        @else
                                            <div class="w-full h-full flex items-center justify-center text-slate-300 font-black text-[10px] uppercase tracking-widest italic" id="preview_about_image_container">No Image</div>
                                        @endif
                                    </div>
                                    <form action="{{ route('admin.cms.update-images') }}" method="POST" enctype="multipart/form-data" class="flex-1 w-full space-y-6">
                                        ...
                                        <div class="relative group/file">
                                            ...
                                            <label for="about_image_input" class="flex items-center justify-center gap-4 w-full py-6 bg-white border-2 border-dashed border-slate-200 rounded-[2rem] text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 cursor-pointer hover:border-indigo-600 hover:text-indigo-600 transition-all duration-300">
                                        ...
                                        <button class="w-full md:w-auto px-10 py-5 bg-indigo-600 text-white rounded-[2rem] font-black uppercase text-[10px] tracking-[0.2em] shadow-xl shadow-indigo-100 hover:bg-indigo-700 hover:scale-[1.02] active:scale-95 transition-all duration-300">SIMPAN FOTO BOLO</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <div x-show="tab === 'revenue'" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-12 panel-revenue">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                            <div class="bg-gradient-to-br from-[#0F172A] to-[#1E293B] rounded-[3rem] shadow-2xl shadow-indigo-100 overflow-hidden p-12 flex items-center justify-between text-white relative group min-h-[200px] border border-white/5 ring-1 ring-white/10">
                                <div class="absolute -right-20 -top-20 w-64 h-64 bg-indigo-500/20 rounded-full blur-[100px] group-hover:scale-150 transition-transform duration-1000"></div>
                                <div class="relative z-10">
                                    <div class="flex items-center gap-3 mb-4">
                                        <div class="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></div>
                                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Kas Platform Bolo</p>
                                    </div>
                                    <h3 class="text-4xl font-black tracking-tight leading-none italic flex items-baseline gap-2">
                                        <span class="text-2xl font-bold text-slate-500">Rp</span>{{ number_format($platformEarnings, 0, ',', '.') }}
                                    </h3>
                                    <p class="text-[9px] font-bold text-slate-500 uppercase mt-4 tracking-[0.2em] bg-white/5 w-fit px-3 py-1 rounded-lg">Admin Fee + Komisi Seller</p>
                                </div>
                                <div class="w-20 h-20 bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2rem] flex items-center justify-center text-indigo-400 shadow-2xl relative z-10 group-hover:rotate-12 transition-all duration-500">
                                    <i class="fa-solid fa-vault text-3xl"></i>
                                </div>
                            </div>
                            
                            <div class="bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 overflow-hidden border border-slate-100 p-12 flex items-center justify-between group min-h-[200px] hover:border-indigo-100 transition-colors duration-500">
                                <div class="relative z-10">
                                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-4">Total Admin Fee</p>
                                    <h3 class="text-4xl font-black text-indigo-600 tracking-tight leading-none flex items-baseline gap-2 italic">
                                        <span class="text-2xl font-bold text-indigo-200">Rp</span>{{ number_format($totalAdminFee, 0, ',', '.') }}
                                    </h3>
                                    <div class="mt-4 flex items-center gap-2">
                                        <i class="fa-solid fa-circle-check text-emerald-500 text-[10px]"></i>
                                        <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Pendapatan Bersih Ops</p>
                                    </div>
                                </div>
                                <div class="w-20 h-20 bg-indigo-50 rounded-[2rem] flex items-center justify-center text-indigo-600 shadow-inner group-hover:bg-indigo-600 group-hover:text-white transition-all duration-500">
                                    <i class="fa-solid fa-percent text-3xl"></i>
                                </div>
                            </div>

                            <div class="bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 overflow-hidden border border-slate-100 p-12 flex items-center justify-between group min-h-[200px] hover:border-slate-300 transition-colors duration-500">
                                <div>
                                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-4">Omzet Penjualan</p>
                                    <h3 class="text-4xl font-black text-slate-900 tracking-tight leading-none italic flex items-baseline gap-2">
                                        <span class="text-2xl font-bold text-slate-300">Rp</span>{{ number_format($totalSalesItems, 0, ',', '.') }}
                                    </h3>
                                    <div class="mt-4 flex items-center gap-2">
                                        <i class="fa-solid fa-cart-shopping text-slate-300 text-[10px]"></i>
                                        <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Total Transaksi Produk</p>
                                    </div>
                                </div>
                                <div class="w-20 h-20 bg-slate-50 rounded-[2rem] flex items-center justify-center text-slate-900 shadow-inner group-hover:-rotate-12 transition-all duration-500">
                        ...
                        <div class="bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 overflow-hidden border border-slate-100 ring-1 ring-slate-100"
                            ...
                            <div class="p-10 border-b border-slate-50 bg-indigo-50/20">
                                <div class="flex items-center gap-6">
                                    ...
                                    <div>
                                        <h3 class="text-2xl font-black text-slate-900 tracking-tight uppercase">Promo & Potongan Bolo</h3>
                                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Kelola aturan gratis ongkir & komisi tiap transaksi</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                                    <div class="space-y-10">
                                        <div class="flex items-center gap-4 mb-2">
                                            ...
                                            <label class="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400">Parameter Gratis Ongkir</label>
                                        </div>
                                    ...
                                    <div class="space-y-10">
                                        <div class="flex items-center gap-4 mb-2">
                                            ...
                                            <label class="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400">Komisi & Pajak Platform</label>
                                        </div>

                                        <div class="grid grid-cols-1 items-center gap-4 group">
                                            <label class="text-[10px] font-black uppercase tracking-[0.1em] text-slate-400 group-focus-within:text-rose-600 transition-colors ml-4">ADMIN FEE PER ORDER (Rp)</label>
                                            <input type="number" name="admin_fee" value="{{ $settings['admin_fee'] ?? '2000' }}" class="w-full px-10 py-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] text-sm font-black focus:ring-8 focus:ring-rose-600/5 focus:border-rose-600 transition-all duration-300">
                                        </div>

                                        <div class="grid grid-cols-1 items-center gap-4 group">
                                            <label class="text-[10px] font-black uppercase tracking-[0.1em] text-slate-400 group-focus-within:text-rose-600 transition-colors ml-4">PERSENTASE KOMISI SELLER (%)</label>
                                            <div class="relative">
                                                <input type="number" name="seller_commission_pct" value="{{ $settings['seller_commission_pct'] ?? '5' }}" class="w-full px-10 py-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] text-sm font-black focus:ring-8 focus:ring-rose-600/5 focus:border-rose-600 transition-all duration-300">
                                                <div class="absolute right-8 top-1/2 -translate-y-1/2 font-black text-rose-400 text-lg">%</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="p-12 border-b border-slate-50 bg-gradient-to-r from-slate-50 to-white flex flex-col lg:flex-row justify-between items-center gap-8">
                                <div>
                                    <div class="flex items-center gap-4 mb-3">
                                        ...
                                        <h3 class="text-2xl font-black text-slate-900 tracking-tight uppercase">Rekapitulasi Keuangan</h3>
                                    </div>
                                    <p class="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em]">Laporan detail transaksi & fee platform bolo</p>
                                </div>
                                <a href="{{ route('admin.cms.revenue.export') }}" class="group px-10 py-6 bg-emerald-600 text-white rounded-[2.5rem] font-black uppercase text-[11px] tracking-[0.3em] shadow-2xl shadow-emerald-100 hover:bg-emerald-700 hover:scale-[1.05] active:scale-95 transition-all duration-300 flex items-center gap-4">
                            ...
                            <div class="p-4 sm:p-10">
                                <div class="overflow-x-auto custom-scrollbar">
                                    <table class="w-full text-left min-w-[800px]">
                                        <thead>
                                            <tr>
                                                <th class="pb-8 px-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Invoice Info</th>
                                                <th class="pb-8 px-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Total Transaksi</th>
                                                <th class="pb-8 px-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 text-center">Admin Fee</th>
                                                <th class="pb-8 px-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Keuntungan Toko</th>
                                                <th class="pb-8 px-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Waktu Transaksi</th>
                                            </tr>
                                        </thead>
                                        <tbody class="divide-y divide-slate-100">
                                            @php
                                            ...
                                            <tr class="group hover:bg-slate-50 transition-all duration-300">
                                                <td class="py-8 px-6">
                                                    <div class="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            <p class="font-black text-sm text-slate-900 group-hover:text-indigo-600 transition-colors">#{{ $trx->invoice_number }}</p>
                                                            <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-1">Selesai Berhasil</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="py-8 px-6">
                                                    <p class="font-black text-sm text-slate-900 italic tracking-tight">Rp{{ number_format($trx->total_price, 0, ',', '.') }}</p>
                                                </td>
                                                <td class="py-8 px-6 text-center">
                                                    <span class="inline-flex px-5 py-2.5 bg-indigo-50 text-indigo-700 rounded-full font-black text-[10px] tracking-widest uppercase border border-indigo-100 group-hover:bg-indigo-600 group-hover:text-white transition-all">
                                                        +Rp{{ number_format($trx->admin_fee, 0, ',', '.') }}
                                                    </span>
                                                </td>
                                                <td class="py-8 px-6">
                                                    <p class="font-black text-sm text-slate-400 uppercase tracking-tighter decoration-indigo-200">Rp{{ number_format($trx->total_price - $trx->admin_fee, 0, ',', '.') }}</p>
                                                </td>
                                                <td class="py-8 px-6">
                                                    <div class="flex flex-col">
                                                        <span class="text-[10px] font-black text-slate-800 uppercase tracking-widest leading-none">{{ $trx->created_at->format('d M Y') }}</span>
                                                        <span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-1">{{ $trx->created_at->format('H:i') }} WIB</span>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
                        ...
                        <div class="bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 overflow-hidden border border-slate-100 ring-1 ring-slate-100">
                            <div class="p-10 border-b border-slate-50 bg-slate-50/30">
                                <div class="flex items-center gap-6">
                                    ...
                                    <div>
                                        <h3 class="text-2xl font-black text-slate-900 tracking-tight uppercase">Konten Footer & Kontak</h3>
                                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Atur informasi sosial media dan copyright di kaki halaman</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                                        <div class="space-y-8">
                                            <div class="flex items-center gap-4 mb-2">
                                                ...
                                                <label class="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400">Social Media Bolo</label>
                                            </div>
                                            ...
                                            <div class="group relative">
                                                ...
                                                <input type="text" name="footer_social_ig" value="{{ $settings['footer_social_ig'] ?? '' }}" 
                                                    class="w-full pl-16 pr-10 py-6 bg-slate-50 border border-slate-100 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 focus:bg-white transition-all outline-none" 
                                        ...
                                        <div class="space-y-8">
                                            <div class="flex items-center gap-4 mb-2">
                                                ...
                                                <label class="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400">Copyright & Info</label>
                                            </div>
    ...
    <div x-data="{ 
        ...
        <div class="bg-white rounded-[2.5rem] w-full max-w-4xl overflow-hidden shadow-2xl relative animate-fade-in-up">
            <div class="p-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/50">
                <div>
                    <h3 class="text-xl font-black text-gray-900 tracking-tight uppercase">POTONG <span class="text-indigo-600">GAMBAR BOLO</span></h3>
                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">Sesuaikan posisi gambar biar pas di mata ya!</p>
                </div>
            ...
            <div class="p-8">
                <div class="h-auto min-h-[300px] max-h-[55vh] rounded-3xl bg-gray-50 border-2 border-dashed border-gray-200 relative overflow-hidden">
                    <img id="cropperImage" src="" class="max-w-full block">
                </div>
                <div class="mt-4 flex justify-center gap-4">
                    <button type="button" onclick="cropper.rotate(-90)" class="p-3 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all text-gray-600">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
                    </button>
                    <button type="button" onclick="cropper.rotate(90)" class="p-3 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all text-gray-600">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 4v5h-.582m-15.356 2A8.001 8.001 0 0119.418 9m0 0H15m-11 11v-5h.581m0 0a8.003 8.003 0 0015.357-2m-15.357 2H9" /></svg>
                    </button>
                    <button type="button" onclick="cropper.zoom(0.1)" class="p-3 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all text-gray-600">
...
<button onclick="closeModal('addCourierModal')" class="p-3 bg-slate-50 text-slate-400 rounded-2xl hover:text-rose-500 transition-all border border-slate-100">
                    ...
                    <form action="{{ route('admin.cms.couriers.store') }}" method="POST" class="p-10 sm:p-14 space-y-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Nama Kurir</label>
                                <input type="text" name="name" required placeholder="Contoh: SADEWA" class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Nama Layanan</label>
                                <input type="text" name="service_name" required placeholder="Contoh: KILAT" class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Multiplier Biaya</label>
                                <input type="number" name="multiplier" step="0.1" value="1.0" required class="w-full px-8 py-5 bg-indigo-50/30 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                                <p class="text-[9px] text-slate-400 mt-2 font-bold uppercase italic ml-4">Misal 1.2 = Biaya naik 20%</p>
                            </div>
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Extra Admin (Rp)</label>
                                <input type="number" name="base_extra_cost" value="0" required class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                                <p class="text-[9px] text-slate-400 mt-2 font-bold uppercase italic ml-4">Flat tambahan ditiap order bolo</p>
                            </div>
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Max Jarak (KM)</label>
                                <input type="number" name="max_distance" placeholder="Unlimited" class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Max Beban (KG)</label>
                                <input type="number" name="max_weight" placeholder="Unlimited" class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="sm:col-span-2 space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Estimasi Waktu</label>
                                <input type="text" name="estimated_time" placeholder="2-4 JAM atau 1 HARI" required class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="sm:col-span-2 space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Deskripsi Singkat</label>
                                <textarea name="description" rows="2" class="w-full px-8 py-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none resize-none" placeholder="Pesan sekarang, sampai sebentar lagi..."></textarea>
                            </div>
                        </div>
                        <div class="pt-6">
                            <button type="submit" class="w-full py-7 bg-[#0F172A] text-white rounded-[2.5rem] font-black uppercase text-[11px] tracking-[0.3em] hover:bg-black transition-all shadow-2xl shadow-indigo-100 border-b-4 border-black/30">SIMPAN KURIR BOLO</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id="editCourierModal" class="fixed inset-0 z-[100] hidden overflow-y-auto">
            ...
            <div class="relative min-h-screen flex items-center justify-center p-6">
                <div class="relative bg-white rounded-[3.5rem] w-full max-w-2xl overflow-hidden shadow-2xl ring-1 ring-white/20">
                    <div class="p-10 sm:p-14 border-b border-slate-50 bg-slate-50/50 flex justify-between items-center">
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                <h3 class="text-2xl font-black text-slate-900 tracking-tight uppercase">Update Kurir Bolo</h3>
                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Sesuaikan preferensi layanan pengiriman</p>
                            </div>
                        </div>
                    ...
                    <form id="editCourierForm" action="" method="POST" class="p-10 sm:p-14 space-y-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Nama Kurir</label>
                                <input type="text" name="name" id="edit_name" required class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Nama Layanan</label>
                                <input type="text" name="service_name" id="edit_service_name" required class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Multiplier Biaya</label>
                                <input type="number" name="multiplier" id="edit_multiplier" step="0.1" required class="w-full px-8 py-5 bg-indigo-50/30 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Extra Admin (Rp)</label>
                                <input type="number" name="base_extra_cost" id="edit_base_extra_cost" required class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Max Jarak (KM)</label>
                                <input type="number" name="max_distance" id="edit_max_distance" class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Max Beban (KG)</label>
                                <input type="number" name="max_weight" id="edit_max_weight" class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="sm:col-span-2 space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Estimasi Waktu</label>
                                <input type="text" name="estimated_time" id="edit_estimated_time" required class="w-full px-8 py-5 bg-slate-50 border border-slate-200 rounded-[2rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none">
                            </div>
                            <div class="sm:col-span-2 space-y-3 group">
                                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Deskripsi Singkat</label>
                                <textarea name="description" id="edit_description" rows="2" class="w-full px-8 py-6 bg-slate-50 border border-slate-200 rounded-[2.5rem] text-sm font-black focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none resize-none"></textarea>
                            </div>
                        </div>
                        <div class="pt-6">
                            <button type="submit" class="w-full py-7 bg-indigo-600 text-white rounded-[2.5rem] font-black uppercase text-[11px] tracking-[0.3em] hover:bg-indigo-700 transition-all shadow-2xl shadow-indigo-100 border-b-4 border-indigo-900/30">UPDATE KURIR BOLO</button>
                        </div>
                    </form>
                </div>
            </div>
