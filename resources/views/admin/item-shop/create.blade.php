                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="group">
                                ...
                                <input type="text" name="kategori" list="category-list" value="{{ old('kategori') }}" placeholder="Ketik atau pilih..." class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-4 focus:ring-emerald-500/10 focus:bg-white transition-all font-bold text-gray-700" required>
                            ...
                            <div class="group">
                                <label class="block text-xs font-medium text-gray-400 mb-2 ml-1">Weight (Gram) <span class="text-red-500">*</span></label>
                                <input type="number" name="berat" value="{{ old('berat', 1000) }}" class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-4 focus:ring-emerald-500/10 focus:bg-white transition-all font-bold text-gray-700" required>
                            </div>
                        </div>
    ...
    <div id="cropModal" class="fixed inset-0 z-[100] hidden items-center justify-center bg-gray-900/80 backdrop-blur-sm p-4">
        <div class="bg-white rounded-2xl w-full max-w-2xl overflow-hidden shadow-lg relative animate-fade-in-up">
            <div class="p-6 border-b border-gray-50 bg-gray-50/50 flex justify-between items-center">
                <div>
                    <h3 class="text-xl font-bold text-gray-900 tracking-tight uppercase">CROP <span class="text-emerald-600">PRODUCT IMAGE</span></h3>
            ...
            <div class="p-8 bg-gray-50/50 border-t border-gray-50 flex gap-4">
                <button type="button" onclick="cancelCrop()" class="flex-1 py-4 bg-white text-gray-500 rounded-2xl font-semibold uppercase text-xs tracking-widest border border-gray-100">Batal</button>
                <button type="button" onclick="saveCrop()" class="flex-1 py-4 bg-emerald-600 text-white rounded-2xl font-semibold uppercase text-xs tracking-widest shadow-lg shadow-emerald-100">Potong Gambar</button>
            </div>
        </div>
    </div>
