                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="crop-actions" class="hidden grid grid-cols-2 gap-3">
                            <button type="button" onclick="saveCrop()" class="py-4 bg-emerald-600 text-white rounded-2xl font-bold text-xs shadow-lg transition-all">Save Changes</button>
                            <button type="button" onclick="cancelCrop()" class="py-4 bg-gray-100 text-gray-400 rounded-2xl font-bold text-xs transition-all">Reset</button>
                        </div>
                    </div>
                </div>
